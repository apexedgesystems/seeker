# ==============================================================================
# Makefile - Seeker project entry point
#
# System diagnostics library. Run `make help` for available targets.
# ==============================================================================
...
VERBOSE ?= 0
ifeq ($(VERBOSE),1)
  CMAKE_VERBOSE_FLAG := -DSEEKER_TARGETS_VERBOSE=ON
else
  CMAKE_VERBOSE_FLAG :=
endif

# Extra CMake args (e.g., make debug CMAKE_EXTRA_ARGS="-DSEEKER_BUILD_GPU=OFF")
CMAKE_EXTRA_ARGS ?=
...
help:
	@printf '%s\n' "Seeker -- System Diagnostics Library"
	@printf '%s\n' "===================================="
	@printf '\n'
	@printf '%s\n' "Native Builds:"
	...
	@printf '  %-28s %s\n' "make install-tools" "Build + install CLI tools"
	...
	@printf '\n'
	@printf '%s\n' "Tools:"
	@printf '  %-28s %s\n' "make tools" "Build all CLI tools (C++)"
	@printf '  %-28s %s\n' "make tools-cpp" "Build C++ tools"
	@printf '\n'
	...
	@printf '  %-28s %s\n' "make docker-prune" "Remove all seeker.* images"
	@printf '\n'
	@printf '%s\n' "Utilities:"
