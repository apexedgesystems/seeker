...
#
# Foundation layer for all Seeker development images. Provides compilers,
# build tools, and formatters. Not run directly.
# ==============================================================================
FROM ubuntu:24.04
...
LABEL org.opencontainers.image.title="seeker.base" \
      org.opencontainers.image.description="Base tooling layer for Seeker development" \
      org.opencontainers.image.vendor="Seeker"
